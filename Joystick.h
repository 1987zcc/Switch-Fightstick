...
typedef enum
{
	...
	SWITCH_ZL = 0x40,
	SWITCH_ZR = 0x80,
	SWITCH_MINUS = 0x100,//减号键
	SWITCH_PLUS = 0x200,//加号键
	SWITCH_LCLICK = 0x400,//按下左摇杆
	SWITCH_RCLICK = 0x800,//按下右摇杆
	SWITCH_HOME = 0x1000,//主页键
	SWITCH_CAPTURE = 0x2000,//截图键
	SWITCH_RELEASE = 0x0000,//松开所有按键和摇杆
} JoystickButtons_t;
